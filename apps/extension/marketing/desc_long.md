...
- Closeness (28 pts) — how tight the score is, building as the game goes on
- Late-Game Pressure (26 pts) — tension that rises through the whole final period, with a boost for tied games headed to overtime
- Momentum (22 pts) — recent scoring runs that spike and then fade
- Lead Changes (14 pts) — back-and-forth chaos
- Comeback Factor (10 pts) — teams climbing out of a hole

The score builds with the game instead of sitting at a flat baseline: an early close game scores low and the tension ramps toward the final buzzer. Recent scoring spikes the live signals and then fades, so even low-scoring sports keep a moving graph instead of a flat line.
