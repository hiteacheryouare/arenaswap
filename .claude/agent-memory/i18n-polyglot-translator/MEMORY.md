...
- [project_pregame_probable_starters_and_leaders.md](project_pregame_probable_starters_and_leaders.md) — 2026-08-27: probable pitcher/goalie headings + 15 team-leader stat labels (incl. PPG/RPG/APG fix) across 11 locales; ESPN-not-domestic-league is the right reference frame; de/fr hockey letters diverge (T/V/PKT, B/A/PTS); zh keeps native totals but borrows PPG/RPG/APG literally like everyone else; all-caps house style overrides real French title-case
